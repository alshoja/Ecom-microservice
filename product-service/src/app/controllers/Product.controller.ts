...
export class ProductController {
  public getProducts(req: Request, res: Response, next: NextFunction): any {
    Product.find()
      .then((products) => {
  ...
  public getProduct(req: Request, res: Response, next: NextFunction): any {
  ...
  public addProduct(req: Request, res: Response, next: NextFunction): any {
  ...
  public updateProduct(req: Request, res: Response, next: NextFunction): any {
  ...
  public deleteProduct(req: Request, res: Response, next: NextFunction): any {
    const productId = req.params.productId;
    Product.findById(productId)
      .then((product) => {
        if (!product) {
